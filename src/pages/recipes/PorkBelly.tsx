      ...
      <section className="relative py-16 md:py-20">
        ...
        <div className="container-wide relative z-10">
          ...
          <h1 className="font-display text-4xl md:text-5xl text-cream tracking-wider">
            Classic Sunday Roast – Pork Belly
          </h1>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            <div>
              ...
              <p className="text-muted-foreground mb-6">
                Perfect your classic Sunday roast with crispy pork belly and all the trimmings. 
                Download the full recipe PDF below for ingredients and step-by-step instructions.
              </p>
              <a 
                href="/recipes/Classic-Sunday-Roast-Pork-Belly.pdf" 
                download
