          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            <div>
              <div className="rounded-2xl overflow-hidden shadow-elevated aspect-[9/16] max-h-[500px]">
                <iframe
                  src="https://www.facebook.com/plugins/video.php?href=https://www.facebook.com/reel/7580465828747832&show_text=false"
            ...
            <div>
              ...
              <p className="text-muted-foreground mb-6">
                Make a hearty and comforting beef short rib stew that's perfect for any occasion. 
                Download the full recipe PDF below for ingredients and step-by-step instructions.
              </p>
              <a 
                href="/recipes/Beef-Short-Rib-Stew.pdf" 
                download
